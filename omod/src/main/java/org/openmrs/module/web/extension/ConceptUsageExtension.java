...
/**
 * <p>
 * This class models an extension point that is used to show how a certain type of metadata in
 * OpenMRS uses an existing Concept. This is initially intended for pages that view a concept, where
 * an extension could be something like Forms or Programs that use a concept, and the conceptUsage
 * member variable is the list of all such things (Forms or Programs for this example) that are
 * currently using the concept in OpenMRS.
 * </p>
 * <p>
 * While this class is geared towards openmrs jsp extension points (hence the mediatype and requried
 * privilege), it's hopeful that it can also be used programmatically to generate reports and other
