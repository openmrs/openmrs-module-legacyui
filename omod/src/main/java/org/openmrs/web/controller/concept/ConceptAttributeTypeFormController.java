...
public class ConceptAttributeTypeFormController {
	...
	private String unretireConceptAttributeType(WebRequest request,
	        @ModelAttribute("attributeType") ConceptAttributeType conceptAttributeType) {
		...
		request.setAttribute(WebConstants.OPENMRS_MSG_ATTR,
		    Context.getMessageSourceService().getMessage("ConceptAttributeType.unretired"), WebRequest.SCOPE_SESSION);
	...
	private String retireConceptAttributeType(WebRequest request, ConceptAttributeType conceptAttributeType,
		...
		request.setAttribute(WebConstants.OPENMRS_MSG_ATTR,
		    Context.getMessageSourceService().getMessage("ConceptAttributeType.retired"), WebRequest.SCOPE_SESSION);
		return CONCEPT_ATTRIBUTE_TYPES_LIST_URL;
	}
	...
	private String saveConceptAttributeType(WebRequest request, ConceptAttributeType conceptAttributeType,
	        ConceptService conceptService) {
		conceptService.saveConceptAttributeType(conceptAttributeType);
		request.setAttribute(WebConstants.OPENMRS_MSG_ATTR,
		    Context.getMessageSourceService().getMessage("ConceptAttributeType.saved"), WebRequest.SCOPE_SESSION);
