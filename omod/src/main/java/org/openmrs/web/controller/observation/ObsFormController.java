...
public class ObsFormController extends SimpleFormController {
	...
	/**
	 * @see org.springframework.web.servlet.mvc.BaseCommandController#onBind(jakarta.servlet.http.HttpServletRequest,
	 *      java.lang.Object)
	 */
	@Override
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object obj,
		...
		if (Context.isAuthenticated()) {
			...
			} else if (newlySavedObs != null) {
				return new ModelAndView(new RedirectView("obs.form?obsId=" + newlySavedObs.getObsId()));
			} else {
				return new ModelAndView(new RedirectView("obs.form?obsId=" + obs.getObsId()));
			}
		}
