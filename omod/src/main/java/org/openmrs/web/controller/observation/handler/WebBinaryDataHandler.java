...
/**
 * Extends functionality of {@link BinaryDataHandler} for web specific views.
 * 
 * @since 1.12
 */
public class WebBinaryDataHandler extends BinaryDataHandler {
