...
public class ConfigureVisitsFormController {
	...
	public String manageEncounterVisitHandlers(Model model) {
		...
		return "/module/legacyui/admin/visits/configureVisits";
	}
	
	@RequestMapping(value = CONFIGURE_VISITS_PATH, method = RequestMethod.POST)
	public String manageEncounterVisitHandlers(@ModelAttribute(VISIT_ENCOUNTER_HANDLER_FORM) ConfigureVisitsForm form,
