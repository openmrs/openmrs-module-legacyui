 ...
 * {@code <openmrs:require>} JSP tag and is enforced by {@link AuthorizationHandlerInterceptor} for
 * Spring controllers and by {@code DwrAuthorizationFilter} for DWR endpoints. Both enforcers reject
 ...
 * Placement:
 * <ul>
 * <li><strong>{@code @Controller}/{@code @RequestMapping} controllers</strong> &mdash; annotate the
 * handler method. Each method's annotation is independent.</li>
 ...
 * privilege the matching JSP's {@code <openmrs:require>} declares (typically the write privilege).</li>
