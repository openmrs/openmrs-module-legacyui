...
<c:if test="${conceptMapType.conceptMapTypeId != null && conceptMapType.retired}">
    <form:form action="unretireConceptMapType.htm" method="post" modelAttribute="conceptMapType">
        ...
        <div class="voidedMessage">
            <div>
                <openmrs:message code="ConceptMapType.retiredMessage"/> &nbsp;<input type="submit"
...
<form:form method="post" action="conceptMapType.form" modelAttribute="conceptMapType">
    ...
    <fieldset>
        ...
        <table cellpadding="3" cellspacing="3" class="form_align_left">
            ...
            <tr>
                <th class="alignRight">
                    <openmrs:message code="ConceptMapType.hidden"/> <img class="help_icon"
                                                                         src="${pageContext.request.contextPath}/images/help.gif"
                                                                         border="0"
                                                                         title="<openmrs:message code="ConceptMapType.hidden.help"/>"/>
                </th>
                <td>
                    ...
                    <table cellpadding="0" cellspacing="20" align="center">
                        <tr>
                            ...
                            <td><input type="button" value="<openmrs:message code="general.cancel"/>"
                                       onclick="javascript:window.location='conceptMapTypeList.list'"></td>
                        </tr>
                    </table>
                </td>
            </tr>
