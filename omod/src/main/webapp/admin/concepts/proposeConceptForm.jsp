            ...
            <tr>
                ...
                <td>
                    <spring:bind path="conceptProposal.encounter">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/encounters/encounter.form?encounterId=${status.value.encounterId}"><openmrs:message
                    ...
                    <spring:bind path="conceptProposal.obsConcept">
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <div dojoType="OpenmrsPopup" widgetId="cSelection" hiddenInputName="conceptId"
                                     searchWidget="cSearch" searchTitle='<openmrs:message code="general.search"/>'></div>
                                <c:if test="${status.errorMessage != ''}"><span
                                        class="error">${status.errorMessage}</span></c:if>
                            </c:otherwise>
                        </c:choose>
                        <div class="description" style="clear: left;" id="conceptDescription"><c:out
                                value="${conceptName.description}"/></div>
                    </spring:bind>
                </td>
            </tr>
        </table>
