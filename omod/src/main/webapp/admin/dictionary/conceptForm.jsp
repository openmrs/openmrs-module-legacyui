                        ...
                        <tr>
							...
							<span
                                ...
                                <spring:bind path="command.preferredNamesByLocale[${loc}]" ignoreNestedPath="true">
                                    <input id="fullySpecPreferred[${loc}]" type="radio" name="${status.expression}"
                                           value="<c:out value="${command.namesByLocale[loc].name}"/>"
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <td <c:if test="${mapStatus.index % 2 == 0}">class='evenRow'</c:if>>
                                            <input type="text" id="<c:out value="term[${mapStatus.index}].name"/>" size="25"
