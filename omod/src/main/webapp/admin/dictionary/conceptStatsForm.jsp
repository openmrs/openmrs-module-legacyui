...
<c:if test="${concept.conceptId != null}">
    <form class="inlineForm" id="jumpForm" action="" method="post">
        ...
        |
        <a href="concept.htm?conceptId=${concept.conceptId}" id="viewConcept" accesskey="v"><openmrs:message
                code="general.view"/></a> |
        <openmrs:hasPrivilege privilege="Manage Concepts"><a href="concept.form?conceptId=${concept.conceptId}" accesskey="e"
                                                             id="editConcept" valign="middle"></openmrs:hasPrivilege>
        <openmrs:message code="general.edit"/>
        <openmrs:hasPrivilege privilege="Manage Concepts"></a></openmrs:hasPrivilege> |
        <a href="#nextConcept" id="nextConcept" accesskey="." valign="middle"
                ...
                <c:if test="${fn:length(outliers) > 0}">
                    <tr>
                        ...
                        <td>
                            ...
                            <br/> <a href="#" onclick="return showHideOutliers(this)"><openmrs:message
                                code="Concept.stats.histogram.showOutliers"/></a> (<c:out value="${fn:length(outliers)}"/>)
                            <br/>
                            <div id="outliers" style="display: none">
                                <table>
                                    <c:forEach items="${outliers}" var="outlier">
                                        <tr>
                                            <td><a target="_edit_obs"
                                                   href="${pageContext.request.contextPath}/admin/observations/obs.form?obsId=${outlier.obsId}">
