    ...
    <tr>
        ...
        <td>
            <spring:bind path="field.description">
                <textarea name="${status.expression}" id="${status.expression}" rows="2" cols="40"
    ...
    <tr id="concept">
        ...
        <td>
            <spring:bind path="field.concept">
                ...
                <div dojoType="ConceptSearch" widgetId="cSearch" conceptId="${status.value.conceptId}"
                     showVerboseListing="true"></div>
                ...
                <tr>
                    <td>
                        ...
                        <spring:bind path="field.tableName">
                            <input type="input" name="${status.expression}" id="${status.expression}"
                                   value="${status.value}"/>
                            <c:if test="${status.errorMessage != ''}">
								<span class="error">
                                        ${status.errorMessage}
