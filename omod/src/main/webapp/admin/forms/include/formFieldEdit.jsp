...
<div id="fieldWarning">
    ...
    <a target="newField" href="field.form?fieldId=" onclick="return editAllFields();"><openmrs:message
            code="Field.editWarning.allForms"/></a> |
    <a target="newField" href="#" onclick="return editFieldForThisForm();"><openmrs:message
            code="Field.editWarning.thisForm"/></a>
</div>
...
<table id="field" width="100%">
    ...
    <tr id="concept">
        ...
        <td valign="top">
            ...
            <div dojoType="OpenmrsPopup" widgetId="cSelection" hiddenInputId="conceptId" searchWidget="cSearch"
                 searchTitle='<openmrs:message code="Concept.find" />' setPositionTop="false"></div>
        </td>
    </tr>
    <tr id="database">
    ...
    <tr>
        <td style="white-space: nowrap;"><label for="selectMultiple"><openmrs:message code="Field.selectMultiple"/></label>
        </td>
...
<table>
    <tr>
        ...
        <td align="center"><openmrs:message code="FormField.maxOccurs"/> <span class="smallMessage">(<openmrs:message
                code="FormField.maxOccurs.help"/>)</span></td>
    </tr>
    <tr>
