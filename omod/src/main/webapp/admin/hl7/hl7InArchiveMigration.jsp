    ...
    <div style="padding: 1em;">
        <div id="message" class="ui-widget" style="margin-bottom: 1em;">
            <div class="ui-state-highlight ui-corner-all" style="padding: 0.5em;">
                ...
                <span class="content" style="font-size: 0.9em;"><openmrs:message htmlEscape="false"
                                                                                 code="Hl7InArchive.migrate.warning.message"/></span>
            </div>
        </div>
        <p>
    ...
    <div style="padding-top: 15px">
        <table cellpadding="3" cellspacing="5" border="0" style="width:auto; font-size:small">
            ...
            <tr class="hl7.migrate.label" id="status_span" style="display: none">
                ...
                <td>
                    <img id="archive_migration_progress_img" src="<openmrs:contextPath/>/images/loading.gif"
                         style="display:none"/>
                    <span id="msg_running" style="display:none"><openmrs:message code="Hl7InArchive.migrate.running"/></span>
                    <span id="msg_complete_not_all" style="display:none"><openmrs:message
                            code="Hl7InArchive.migrate.complete.not.all"/></span>
                    <span id="msg_complete_all" style="display:none"><openmrs:message
                            code="Hl7InArchive.migrate.complete.all"/></span>
