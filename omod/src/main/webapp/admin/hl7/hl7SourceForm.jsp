...
<openmrs:extensionPoint pointId="org.openmrs.admin.hl7.Hl7SourceForm.belowTitle" type="html"
                        parameters="id=${hl7Source.id}"/>
...
<form method="post">
    <fieldset>
                ...
                <td valign="top">
                    <spring:bind path="hl7Source.description">
                        <textarea name="description" rows="3" cols="40"
                                  onkeypress="return maxLength(this, 1024);">${status.value}</textarea>
                        <c:if test="${status.errorMessage != ''}"><c:if test="${status.errorMessage != ''}"><span
                                class="error">${status.errorMessage}</span></c:if></c:if>
                    </spring:bind>
                </td>
        ...
        <openmrs:extensionPoint pointId="org.openmrs.admin.hl7.ehl7SourceForm.inForm" type="html"
                                parameters="id=${hl7Source.id}"/>
