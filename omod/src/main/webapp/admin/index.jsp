...
<table border="0" width="93%">
    ...
    <tr>
        ...
        <td valign="top" width="30%">
            ...
            <openmrs:hasPrivilege
                    privilege="View Concepts,Manage Concept Classes,Manage Concept Datatypes,Manage Concept Proposals">
                <div class="adminMenuList">
                        ...
                        <div class="adminMenuList">
                            ...
                            <ul id="menu">
                                <c:forEach items="${extension.links}" var="link">
                                    <li><a href='<openmrs_tag:url value="${link.key}"/>'><openmrs:message
                                            code='${link.value}'/></a></li>
                                </c:forEach>
                            </ul>
                        </div>
                    </c:catch>
