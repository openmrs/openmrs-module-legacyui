...
<openmrs:require privilege="Manage Location Attribute Types" otherwise="/login.htm"
                 redirect="/admin/locations/locationAttributeTypes.list"/>
...
<openmrs:extensionPoint pointId="org.openmrs.admin.locations.locationAttributeType.belowTitle" type="html"
                        parameters="id=${ attributeType.id }"/>
...
<form method="post">
    <fieldset>
        ...
        <openmrs:extensionPoint pointId="org.openmrs.admin.locations.locationAttributeType.inForm" type="html"
                                parameters="id=${ attributeType.id }"/>
...
<openmrs:extensionPoint pointId="org.openmrs.admin.locations.locationAttributeTypeForm.footer" type="html"
                        parameters="id=${ attributeType.id }"/>
