...
<openmrs:require privilege="Manage Implementation Id" otherwise="/login.htm"
                 redirect="/admin/maintenance/implementationid.form"/>
    ...
    <table>
        <tr>
            <spring:bind path="implId.name">
                <td style="white-space: nowrap"><openmrs:message code="ImplementationId.name"/><span
        ...
        <tr>
            <spring:bind path="implId.implementationId">
                <td style="white-space: nowrap"><openmrs:message code="ImplementationId.implementationId"/><span
                        class="required">*</span></td>
                <td style="white-space: nowrap">
