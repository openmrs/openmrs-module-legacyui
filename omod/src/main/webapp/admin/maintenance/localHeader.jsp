<ul id="menu">
	...
	<openmrs:hasPrivilege privilege="Manage Search Index">
		<li <c:if test='<%= request.getRequestURI().contains("searchIndex") %>'>class="active"</c:if>>
			<a href="${pageContext.request.contextPath}/admin/maintenance/searchIndex.htm">
				<openmrs:message code="SearchIndex.title"/>
			</a>
		</li>
	</openmrs:hasPrivilege>
