...
<openmrs:require privilege="Manage Identifier Types" otherwise="/login.htm"
                 redirect="/admin/patients/patientIdentifierType.list"/>
...
<c:if test="${PatientIdentifierTypesLocked != 'true'}"> <a href="patientIdentifierType.form"> <openmrs:message
        code="PatientIdentifierType.add"/> </a> </c:if>
