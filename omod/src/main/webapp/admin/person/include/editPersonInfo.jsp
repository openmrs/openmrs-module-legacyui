    ...
    <tr>
        ...
        <td><spring:bind path="gender">
            <openmrs:forEachRecord name="gender">
                <input type="radio" name="gender" id="${record.key}" value="${record.key}"
...
<tr>
    <td>
        ...
        <i style="font-weight: normal; font-size: .8em;">(<openmrs:message code="general.format"/>:
...
<openmrs:forEachDisplayAttributeType personType="" displayType="viewing" var="attrType">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <tr>
                <td><openmrs:message code="PersonAttributeType.${fn:replace(attrType.name, ' ', '')}"
...
<tr id="deathInformation">
    ...
    <td style="white-space: nowrap">
        ...
        <spring:bind path="causeOfDeath">
            <openmrs:fieldGen type="org.openmrs.Concept" formFieldName="causeOfDeath" val="${status.value}"
...
<tr id="personVoidReasonRow"
    <c:if test="${patient.voided == false}">style="display: none"</c:if> >
