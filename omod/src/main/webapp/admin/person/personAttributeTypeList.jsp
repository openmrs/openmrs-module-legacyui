...
<openmrs:require privilege="Manage Person Attribute Types" otherwise="/login.htm"
                 redirect="/admin/person/personAttributeType.list"/>
...
<c:if test="${PersonAttributeTypesLocked != 'true'}"> <a href="personAttributeType.form"> <openmrs:message
        code="PersonAttributeType.add"/> </a> </c:if>
...
<form method="post" class="box">
    <table>
        ...
        <c:forEach var="personAttributeType" items="${personAttributeTypeList}">
            <tr>
                <td valign="top"><input type="checkbox" name="personAttributeTypeId"
                                        value="${personAttributeType.personAttributeTypeId}"></td>
    ...
    <input type="submit" value='<openmrs:message code="PersonAttributeType.moveup"/>'
           onclick="document.getElementById('saveAction').value='moveup'">
    <input type="submit" value='<openmrs:message code="PersonAttributeType.movedown"/>'
           onclick="document.getElementById('saveAction').value='movedown'">
</form>
...
<form method="post" class="box">
    <table>
        <tr>
            ...
            <td><input type="text" size="50" name="patientListingAttributeTypes"
                       value="<c:out value='${patientListingAttributeTypes}' />"/></td>
        ...
        <tr>
            ...
            <td><input type="text" size="50" name="patientViewingAttributeTypes"
                       value="<c:out value='${patientViewingAttributeTypes}' />"/></td>
        ...
        <tr>
            ...
            <td><input type="text" size="50" name="patientHeaderAttributeTypes"
                       value="<c:out value='${patientHeaderAttributeTypes}' />"/></td>
        ...
        <tr>
            ...
            <td><input type="text" size="50" name="userListingAttributeTypes"
                       value="<c:out value='${userListingAttributeTypes}' />"/></td>
        ...
        <tr>
            ...
            <td><input type="text" size="50" name="userViewingAttributeTypes"
                       value="<c:out value='${userViewingAttributeTypes}' />"/></td>
