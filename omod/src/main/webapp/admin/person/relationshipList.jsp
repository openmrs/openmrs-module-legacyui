...
<a href="${pageContext.request.contextPath}/admin/person/relationship.form"><openmrs:message
        code="Relationship.add"/></a><br/><br/>

<div id="findRelationship">
    <b class="boxHeader"><openmrs:message code="Person.find"/></b>
    <div class="box">
        <div dojoType="PersonSearch" widgetId="pSearch" inputName="personName"
             searchLabel='<openmrs:message code="Person.searchBox"/>'></div>
    </div>
</div>
