...
<openmrs:require privilege="Manage Relationship Types" otherwise="/login.htm"
                 redirect="/admin/person/relationshipTypeViews.form"/>
    ...
    <table>
        ...
        <c:forEach var="relationshipType" items="${relationshipTypeList}">
            <tr>
                ...
                <td>
                    <input type="checkbox" name="preferredTypes" value="${relationshipType.relationshipTypeId}"
                           <c:if test="${fn:contains(preferredTypes, relationshipType)}">checked</c:if> />
                </td>
            </tr>
        </c:forEach>
    </table>
...
<b><openmrs:message code="RelationshipType.views.order"/>:</b> <openmrs:message code="RelationshipType.views.order.help"/>
<br/>
<b><openmrs:message code="RelationshipType.views.preferred"/>:</b>
<openmrs:message code="RelationshipType.views.preferred.help"/> <br/>
