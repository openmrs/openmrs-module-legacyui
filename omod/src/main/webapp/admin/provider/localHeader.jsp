<ul id="menu">
    ...
    <openmrs:hasPrivilege
            privilege="Manage Provider Attribute Types,View Provider Attribute Types,Purge Provider Attribute Types">
        <li
                <c:if test='<%= request.getRequestURI().contains("provider/providerAttributeTypeList.jsp") %>'>class="active"</c:if>>
