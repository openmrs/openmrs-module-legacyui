...
<openmrs:extensionPoint pointId="org.openmrs.admin.provider.providerForm.belowTitle" type="html"
                        parameters="providerAttributeTypeId=${providerAttributeType.providerAttributeTypeId}"/>
...
<form method="post">
    <fieldset>
        <table>
            ...
            <tr>
                <c:if test="${providerAttributeType.providerAttributeTypeId != null}">
                    ...
                    <td colspan="${fn:length(locales)}"><font color="#D0D0D0"><sub>${providerAttributeType.uuid}</sub></font>
                    </td>
                </c:if>
            </tr>
        </table>
        ...
        <openmrs:extensionPoint pointId="org.openmrs.admin.provider.providerForm.inForm" type="html"
                                parameters="providerAttributeTypeId=${providerAttributeType.providerAttributeTypeId}"/>
...
<c:if test="${not providerAttributeType.retired && not empty providerAttributeType.providerAttributeTypeId}">
    <form method="post">
        <fieldset>
            ...
            <br/>
            <input type="submit" value='<openmrs:message code="ProviderAttributeType.retireProviderAttributeType"/>'
                   name="retire"/>
        </fieldset>
    </form>
</c:if>
    ...
    <openmrs:hasPrivilege privilege="Purge Provider Attribute Types">
        <form id="purge" method="post" onsubmit="return confirmPurge()">
            <fieldset>
                ...
                <input type="submit" value='<openmrs:message code="ProviderAttributeType.purgeProviderAttributeType"/>'
                       name="purge"/>
            </fieldset>
        </form>
    </openmrs:hasPrivilege>
...
<openmrs:extensionPoint pointId="org.openmrs.admin.provider.providerAttributeTypeForm.footer" type="html"
                        parameters="providerAttributeTypeId=${providerAttributeType.providerAttributeTypeId}"/>
