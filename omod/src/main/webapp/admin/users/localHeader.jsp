<ul id="menu">
    ...
    <openmrs:hasPrivilege privilege="Edit Users">
        <li id="legacyui-mangeUsers"
            <c:if test='<%= request.getRequestURI().contains("users/users") %>'>class="active"</c:if>>
    ...
    <openmrs:hasPrivilege privilege="Manage Privileges">
        <li id="legacyui-managePrivileges"
            <c:if test='<%= request.getRequestURI().contains("privilege") %>'>class="active"</c:if>>
