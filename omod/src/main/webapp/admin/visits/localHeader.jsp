<ul id="menu">
    ...
    <openmrs:hasPrivilege privilege="Manage Visit Types,View Visit Types">
        <li id="legacyui-manageVisitTypes"
            <c:if test='<%= request.getRequestURI().contains("visits/visitTypeList.jsp") %>'>class="active"</c:if>>
    ...
    <openmrs:hasPrivilege privilege="Manage Visit Attribute Types,View Visit Attribute Types,Purge Visit Attribute Types">
        <li id="legacyui-manageVisitAttributeTypes"
            <c:if test='<%= request.getRequestURI().contains("visits/visitAttributeTypeList.jsp") %>'>class="active"</c:if>>
    ...
    <openmrs:hasPrivilege privilege="Configure Visits">
        <li id="legacyui-configureVisits"
            <c:if test='<%= request.getRequestURI().contains("configureVisits") %>'>class="active"</c:if>>
