...
<openmrs:require privilege="Manage Visit Attribute Types,Purge Visit Attribute Types" otherwise="/login.htm"
                 redirect="/admin/visits/visitAttributeType.list"/>
...
<openmrs:extensionPoint pointId="org.openmrs.admin.visits.visitForm.belowTitle" type="html"
                        parameters="visitAttributeTypeId=${visitAttributeType.visitAttributeTypeId}"/>
...
<form method="post">
    <fieldset>
        <table>
            ...
            <c:if test="${visitAttributeType.visitAttributeTypeId != null}">
                <tr>
                    ...
                    <td colspan="${fn:length(locales)}"><font color="#D0D0D0"><sub>${visitAttributeType.uuid}</sub></font>
                    </td>
                </tr>
            </c:if>
        </table>
        ...
        <openmrs:extensionPoint pointId="org.openmrs.admin.visits.visitForm.inForm" type="html"
                                parameters="visitAttributeTypeId=${visitAttributeType.visitAttributeTypeId}"/>
...
<c:if test="${not visitAttributeType.retired && not empty visitAttributeType.visitAttributeTypeId}">
    <form method="post">
        <fieldset>
            ...
            <br/>
            <input type="submit" value='<openmrs:message code="VisitAttributeType.retireVisitAttributeType"/>'
                   name="retire"/>
        </fieldset>
    </form>
</c:if>
    ...
    <openmrs:hasPrivilege privilege="Purge Visit Attribute Types">
        <form id="purge" method="post" onsubmit="return confirmPurge()">
            <fieldset>
                ...
                <input type="submit" value='<openmrs:message code="VisitAttributeType.purgeVisitAttributeType"/>'
                       name="purge"/>
            </fieldset>
        </form>
    </openmrs:hasPrivilege>
...
<openmrs:extensionPoint pointId="org.openmrs.admin.visits.visitAttributeTypeForm.footer" type="html"
                        parameters="visitAttributeTypeId=${visitAttributeType.visitAttributeTypeId}"/>
