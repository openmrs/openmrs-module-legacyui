...
<form method="post" style="padding:15px;">
    <c:if test="${secretQuestion == null}">
        ...
        <table>
            ...
            <tr>
                <td></td>
                <td align="left"><input type="submit" value='<openmrs:message code="forgotPassword.showSecretQuestion"/>'/>
                </td>
            </tr>
        </table>
    </c:if>
    <c:if test="${secretQuestion != null}">
        ...
        <table>
            ...
            <tr>
                ...
                <td align="left"><input type="password" name="secretAnswer" value="" id="secretAnswer" size="25"
                                        autocomplete="off"></td>
            </tr>
            <tr>
                <td></td>
