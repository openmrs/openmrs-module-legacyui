...
<ul>
    ...
    <br/>
    <ul>
        <li><openmrs:message code="help.about.text" htmlEscape="false"
                             arguments="<a href='https://wiki.openmrs.org/x/3gNN'>,</a>"/></li>
        <br/>
        <li><openmrs:message code="help.technical.text" htmlEscape="false"
                             arguments="<a href='https://wiki.openmrs.org/x/-g4z'>,</a>"/></li>
        <br/>
    </ul>
...
<br/>
<ul>
    <li><openmrs:message code="help.irc.text" htmlEscape="false"
                         arguments="<a href='https://wiki.openmrs.org/x/EQAP'>,</a>"/></li>
    <br>
    <li><openmrs:message code="help.mailing.text" htmlEscape="false"
                         arguments="<a href='https://wiki.openmrs.org/display/RES/Mailing+Lists'>,</a>"/></li>
</ul>
