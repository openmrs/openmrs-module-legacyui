...
<openmrs:authentication>
    <c:if test="${authenticatedUser != null}">
        <openmrs:extensionPoint pointId="org.openmrs.navigation.homepage" type="html" varStatus="status">
            ...
            <openmrs:portlet url="${extension.portletUrl}" parameters="${extension.portletParameters}"
...
<c:if test="${not anyExtension}">
    <center>
        <img src="${pageContext.request.contextPath}<spring:theme code="image.logo.large" text="/images/openmrs_logo_white_large.png"/>"
             alt='<openmrs:message code="openmrs.title"/>' title='<openmrs:message code="openmrs.title"/>'/>
