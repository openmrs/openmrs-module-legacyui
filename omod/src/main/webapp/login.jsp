...
<c:if test="${foundMissingPrivileges == true}">
    <c:if test="${not empty alertMessage}">
        <div id="responseDiv" style="display: none">
            ...
            <span id="failureMsg" class="error" style="display: none"><openmrs:message
                    code="error.failedToSendRequest"/></span>
        </div>
    </c:if>
    ...
    <c:if test="${not empty alertMessage}">
        <div id="sendAlertDetails">
            ...
            <br/><br/>
            <input id="notificationButton" type="button" value="<openmrs:message code="general.alertSystemAdmin" />"
                   onclick="createAlert()"/>
        </div>
    </c:if>
