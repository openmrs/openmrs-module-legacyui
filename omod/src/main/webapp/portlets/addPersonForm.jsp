            ...
            <form method="get" action="${model.postURL}" onSubmit="return validateForm()">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="addName" id="personName" size="40"
                                   onKeyUp="hideError('nameError'); hideError('invalidNameError');"/>
                    ...
                    <tr>
                        <td><openmrs:message code="Person.birthdate"/><span class="required">*</span><br/><i
                                style="font-weight: normal; font-size: 0.8em;">(<openmrs:message code="general.format"/>:
                            <openmrs:datePattern/>)</i></td>
                        <td valign="top">
                            <input type="text" name="addBirthdate" id="birthdate" size="11" value=""
                                   onfocus="showCalendar(this,60)" onChange="hideError('birthdateError')"/>
                            <openmrs:message code="Person.age.or"/>
                            <input type="text" name="addAge" id="age" size="5" value=""
                                   onKeyUp="hideError('birthdateError')"/>
                            <span class="error" id="birthdateError"><openmrs:message
                                    code="Person.birthdate.required"/></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <openmrs:forEachRecord name="gender">
                                <input type="radio" name="addGender" id="gender-${record.key}" value="${record.key}"
                                       onClick="hideError('genderError')"/><label for="gender-${record.key}">
                                <openmrs:message code="Person.gender.${record.value}"/> </label>
