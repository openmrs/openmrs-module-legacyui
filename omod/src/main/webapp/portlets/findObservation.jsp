            ...
            <div id="findObservation">
                ...
                <div class="box">
                    <form>
                        ...
                        <input type="radio" checked name="selectSearchStyle" value="byPatientAndConcept"
                               onClick="hideDiv('searchByEncounter');showDiv('searchByPatientConcept');"/>
                        <openmrs:message code="ObsSearch.byPersonAndConcept"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="selectSearchStyle" value="byEncounter"
                               onClick="hideDiv('searchByPatientConcept');showDiv('searchByEncounter');"/>
                        ...
                        <div id="searchByPatientConcept">
                            <table>
                                ...
                                <tr class="searchObsByConcept">
                                    <td><span><openmrs:message code="Obs.concept"/></span> <span
                                            class="instructions">(<openmrs:message code="general.optional"/>)</span>:
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <input type="button" value="<openmrs:message code="general.cancel" />"
                                               onClick="obsSearchClear('personId', 'conceptId', '');"/>
                                        <input type="button" value="<openmrs:message code="general.searchButton" />"
                                               onClick="obsSearch('personId', 'conceptId', '', 'obsTable', 'observationList');"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div id="searchByEncounter" style="display:none;">
                            <table>
                                <tr class="searchObsByEncounter">
                                    ...
                                    <td><openmrs_tag:encounterField formFieldName="encounterId" formFieldId="encounterId"
                                                                    searchLabel="${encounterLabel}" initialValue=""
                                                                    linkUrl="" callback=""/></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <p/>
                                        <input type="button" value="<openmrs:message code="general.cancel" />"
                                               onClick="obsSearchClear('', '', 'encounterId');"/>
                                        <input type="button" value="<openmrs:message code="general.searchButton" />"
                                               onClick="obsSearch('', '', 'encounterId', 'obsTable', 'observationList');"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="box">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <th class="obsFormHeader"><openmrs:message code="Obs.form"/> (<openmrs:message
                                    code="Obs.encounterDate"/>)
                            </th>
