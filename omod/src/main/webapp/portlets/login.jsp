...
<form method="post" action="<openmrs:contextPath/>/ms/legacyui/loginServlet" style="padding:15px; width: 300px;"
      autocomplete="off">
    <table>
        <tr>
            <td><openmrs:message code="User.username"/>:</td>
            <td><input type="text" name="uname" value="<c:out value='${param.username}' />" id="username" size="25"
                       maxlength="50"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td><a class="forgotPasswordLink" href="${pageContext.request.contextPath}/forgotPassword.form"><openmrs:message
                    code="User.password.forgot"/></a></td>
        </tr>
    </table>
    <br/>
