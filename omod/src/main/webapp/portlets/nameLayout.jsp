                        ...
                        <c:if test="${model.layoutShowExtended == 'true'}">
                            <td>
                                <spring:bind path="preferred">
                                    ...
                                    <input type="checkbox" name="${status.expression}" onclick="preferredBoxClick(this)"
                                           alt="personName" value="true"
                            ...
                            <td>
                                <spring:bind path="preferred">
                                    ...
                                    <input type="checkbox" name="${status.expression}"
                                           onclick="if (preferredBoxClick) preferredBoxClick(this)" alt="personName"
                                           value="true"
                                           <c:if test="${status.value == true}">checked</c:if> />
                                    <c:if test="${status.errorMessage != ''}"><span
                                            class="error">${status.errorMessage}</span></c:if>
                                    ...
                                    <spring:bind path="voided">
                                        ...
                                        <input type="checkbox" name="${status.expression}"
                                               ...
                                               onClick="toggleLayer('<spring:bind
                                                       path="personNameId">voidReasonNameRow-${status.value}</spring:bind>'); if (voidedBoxClicked) voidedBoxClicked(this); "
                                        />
                                    </spring:bind>
                                </td>
                            </tr>
