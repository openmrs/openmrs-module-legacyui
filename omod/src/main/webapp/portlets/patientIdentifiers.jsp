                ...
                <td>
                    ...
                    <c:if test="${found!=null}">
                        <input type="text" id="identifier_${iter.index}" onKeyUp="identifierFieldChanged(${iter.index})"
                               value="<c:out value="${found.identifier}" />"/>
                        <openmrs:fieldGen
                    ...
                    <input id="idSaveButton_${iter.index}" type="button" value="<openmrs:message code="general.save" />"
                           disabled="true" onClick="handleSaveIdentifier(${iter.index})"/>
                </td>
                <td>
