                    ...
                    .dataTable(
                        {
                            ...
                            "fnDrawCallback": function (
                                ...
                                pageInfoElement.innerHTML = '<b><openmrs:message code="patientDashboard.visits.showing.pages"/>'.replace('{0}', currentPage).replace('{1}', pageCount) + '</b>';
    ...
    <div id="visitPortlet">
        ...
        <openmrs:hasPrivilege privilege="View Visits, View Encounters">
            <openmrs:hasPrivilege privilege="Add Visits">
                &nbsp;<a
                href="<openmrs:contextPath/>/admin/visits/visit.form?patientId=<c:out
                    value="${model.patient.patientId}"/>"><openmrs:message
                    code="Visit.add"/></a>
                <br/>
                <br/>
