...
<c:if test="${model.showDefinedNumberOfEncounters}">  <%-- showDefinedNumberOfEncounters shows the given number of encounters entered in the dashboard.encounters.maximumNumberToShow global property value --%>
    <openmrs:hasPrivilege privilege="View Encounters">
        ...
        <openmrs:portlet url="patientEncounters" id="patientDashboardEncounters" patientId="${patient.patientId}"
                         parameters="num=${maxEncs}|title=Encounter.last.definedNumberOfEncounters|formEntryReturnUrl=${pageContext.request.contextPath}/patientDashboard.form"/>
        <br/>
...
<c:if test="${model.anyUpdatedFormEntryModules}">
    ...
    <script type="text/javascript">
        ...
        $j(document).ready(function () {
            ...
            <%-- trigger filter-and-draw of datatable now --%>
