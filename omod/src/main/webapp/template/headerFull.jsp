...
<html xmlns="http://www.w3.org/1999/xhtml"
	...
	<head>
		...
		<c:if test="${empty DO_NOT_INCLUDE_JQUERY}">
			...
			<openmrs:htmlInclude file="/scripts/jquery/jquery-migrate.min.js" />
...
<body>
	<div id="pageBody">
		...
		<%@ include file="/WEB-INF/view/module/legacyui/template/banner.jsp" %>
		...
		<div id="content">
			...
			<c:if test="${msg != null}">
				<div id="openmrs_msg"><openmrs:message code="${msg}" text="${msg}" arguments="${msgArgs}"  htmlEscape="true" /></div>
			</c:if>
			<c:if test="${err != null}">
